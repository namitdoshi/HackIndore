...
$text = 'hello kaise ho';
    ...
    $url = 'https://www.googleapis.com/language/translate/v2/detect?key=' . $apiKey . '&q=' . rawurlencode($text) . '&target=hi&model=nmt';
    ...
    $url = 'https://www.googleapis.com/language/translate/v2?key=' . $apiKey . '&q=' . rawurlencode($text) . '&source=eng&target=hi&source=en&model=nmt';
    //$url = 'https://www.googleapis.com/language/translate/v2?key=' . $apiKey;
    $handle = curl_init($url);
    //curl_setopt($handle, CURLOPT_SSL_VERIFYPEER, FALSE);
    //curl_setopt($handle, CURLOPT_SSL_VERIFYHOST, FALSE);
